...
+ Bu kurs [C ve Sistem Programcıları Derneği](http://www.csystem.org/) tarafından `"Sistem Bilgisayar"` işbirliği ile düzenlenmektedir. Kurs `19 Ekim 2020` tarihinde başlayacaktır.
...
## Kurs Ücreti
Programın toplam ücreti `3.500 TL`‘dir. Öğrencilere `(öğrencilik durumunu belgelemeleri kaydıyla)` %10 indirim uygulanmaktadır. Katılımcılar kurs ücretini dilerlerse `2` taksitte ödeyebilirler.
